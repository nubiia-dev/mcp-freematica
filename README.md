...
| `freematica_list_pcrm_casos`                              | `GET /pcrm/v2/casos`                                           | Lista paginada de casos CRM (tickets de soporte/incidencias)                                       |
...
| `freematica_list_pcrm_documentos_usuario_v1`              | `GET /pcrm/v1/usuarios/{idUsuario}/documentos`                 | Lista paginada de documentos de portal de un usuario (v1)                                          |
| `freematica_get_pcrm_documento_usuario_v1`                | `GET /pcrm/v1/usuarios/{idUsuario}/documentos/{idDocumento}`   | Detalle de un documento de portal (v1)                                                             |
| `freematica_list_pcrm_documentos_usuario_v2`              | `GET /pcrm/v2/usuarios/{idUsuario}/documentos`                 | Lista paginada de documentos de portal de un usuario (v2)                                          |
| `freematica_get_pcrm_documento_usuario_v2`                | `GET /pcrm/v2/usuarios/{idUsuario}/documentos/{idDocumento}`   | Detalle de un documento de portal (v2)                                                             |
...
| `freematica_get_oportunidad_negocio_v1`                   | `GET /pcrm/v1/oportunidades-negocio/{idReg}`                   | Detalle de oportunidad de negocio (v1)                                                             |
...
| `freematica_get_tipo_oportunidad_negocio`                 | `GET /pcrm/v2/tipos-oportunidad-negocio/{idReg}`               | Detalle de un tipo de oportunidad de negocio                                                       |
| `freematica_list_clientes_v1`                             | `GET /pgrl/v1/clientes`                                        | Lista paginada de clientes (v1). Preferir v2 para datos más completos.                             |
| `freematica_get_cliente_v1`                               | `GET /pgrl/v1/clientes/{idReg}`                                | Detalle de un cliente (v1)                                                                         |
...
| `freematica_list_localizaciones_cobro_clientes_v1`        | `GET /pgrl/v1/localizaciones-cobro-clientes`                   | Lista paginada de localizaciones de cobro de clientes (v1)                                         |
| `freematica_get_localizacion_cobro_cliente`               | `GET /pgrl/v1/localizaciones-cobro-clientes/{idReg}`           | Detalle de localización de cobro de cliente (v1)                                                   |
| `freematica_get_localizacion_cobro_cliente_v2`            | `GET /pgrl/v2/localizaciones-cobro-clientes/{idReg}`           | Detalle de localización de cobro de cliente (v2)                                                   |
| `freematica_list_localizaciones_envio_clientes_v1`        | `GET /pgrl/v1/localizaciones-envio-clientes`                   | Lista paginada de localizaciones de envío de clientes (v1)                                         |
| `freematica_get_localizacion_envio_cliente`               | `GET /pgrl/v1/localizaciones-envio-clientes/{idReg}`           | Detalle de localización de envío de cliente (v1)                                                   |
| `freematica_get_localizacion_envio_cliente_v2`            | `GET /pgrl/v2/localizaciones-envio-clientes/{idReg}`           | Detalle de localización de envío de cliente (v2)                                                   |
| `freematica_get_localizacion_factura_cliente`             | `GET /pgrl/v1/localizaciones-factura-clientes/{idReg}`         | Detalle de localización de factura de cliente (v1)                                                 |
| `freematica_list_localizaciones_servicio_clientes_v1`     | `GET /pgrl/v1/localizaciones-servicio-clientes`                | Lista paginada de localizaciones de servicio de clientes (v1)                                      |
| `freematica_get_localizacion_servicio_cliente`            | `GET /pgrl/v1/localizaciones-servicio-clientes/{idReg}`        | Detalle de localización de servicio de cliente (v1)                                                |
| `freematica_get_localizacion_servicio_cliente_v2`         | `GET /pgrl/v2/localizaciones-servicio-clientes/{idReg}`        | Detalle de localización de servicio de cliente (v2)                                                |
| `freematica_list_localizaciones_pago_proveedores_v1`      | `GET /pgrl/v1/localizaciones-pago-proveedores`                 | Lista paginada de localizaciones de pago de proveedores (v1)                                       |
| `freematica_get_localizacion_pago_proveedor`              | `GET /pgrl/v1/localizaciones-pago-proveedores/{idReg}`         | Detalle de localización de pago de proveedor (v1)                                                  |
| `freematica_get_localizacion_pago_proveedor_v2`           | `GET /pgrl/v2/localizaciones-pago-proveedores/{idReg}`         | Detalle de localización de pago de proveedor (v2)                                                  |
| `freematica_list_proveedores_v1`                          | `GET /pgrl/v1/proveedores`                                     | Lista paginada de proveedores (v1)                                                                 |
| `freematica_list_cargos_clientes`                         | `GET /pgrl/v2/cargos-clientes`                                 | Lista paginada de cargos de clientes (roles de contactos)                                          |
...
| `freematica_list_delegaciones_v1`                         | `GET /pgrl/v1/delegaciones`                                    | Lista paginada de delegaciones (v1). También vía freematica_get_master_data.                       |
| `freematica_get_delegacion_v1`                            | `GET /pgrl/v1/delegaciones/{idReg}`                            | Detalle de una delegación (v1)                                                                     |
| `freematica_list_delegaciones_agrupcod`                   | `GET /pgrl/v1/delegaciones/agrupcod`                           | Lista paginada de delegaciones agrupadas por código                                                |
| `freematica_list_delegaciones_v2`                         | `GET /pgrl/v2/delegaciones`                                    | Lista paginada de delegaciones (v2)                                                                |
| `freematica_get_delegacion_v2`                            | `GET /pgrl/v2/delegaciones/{idReg}`                            | Detalle de una delegación (v2)                                                                     |
| `freematica_list_empresas`                                | `GET /pgrl/v1/empresas`                                        | Lista paginada de empresas. También vía freematica_get_master_data.                                |
| `freematica_get_empresa`                                  | `GET /pgrl/v1/empresas/{idReg}`                                | Detalle de una empresa                                                                             |
| `freematica_list_paises`                                  | `GET /pgrl/v1/paises`                                          | Lista paginada de países. También vía freematica_get_master_data.                                  |
| `freematica_list_provincias`                              | `GET /pgrl/v1/provincias`                                      | Lista paginada de provincias. También vía freematica_get_master_data.                              |
| `freematica_list_nacionalidades`                          | `GET /pgrl/v1/nacionalidades`                                  | Lista paginada de nacionalidades. También vía freematica_get_master_data.                          |
...
| `freematica_list_lineas_negocio`                          | `GET /pgrl/v2/lineas-negocio`                                  | Lista paginada de líneas de negocio. También vía freematica_get_master_data.                       |
...
| `freematica_get_configuracion_usuario`                    | `GET /pgrl/v1/configuracion-usuario/{idReg}`                   | Configuración de un usuario por idReg                                                              |
...
| `freematica_list_instalador_propuestas_compras`           | `GET /pgrl/v1/instaladores/{idReg}/propuestas-compras`         | Propuestas de compra de un instalador                                                              |
...
| `freematica_list_correos_destinatarios`                   | `GET /pgrl/v2/correos/destinatarios`                           | Lista paginada de destinatarios de correos                                                         |
| `freematica_get_correos_totales`                          | `GET /pgrl/v2/correos/totales`                                 | Totales de correos (v2)                                                                            |
...
| `freematica_update_pcrm_actividad`                      | `PUT /pcrm/v2/actividades/{idReg}`                              | Actualización de actividad CRM                                   |
| `freematica_create_pcrm_caso`                           | `POST /pcrm/v2/casos`                                           | Alta de caso CRM                                                 |
| `freematica_update_pcrm_caso`                           | `PUT /pcrm/v2/casos/{idReg}`                                    | Actualización de caso CRM                                        |
| `freematica_update_pcrm_documento_usuario_v1`           | `PUT /pcrm/v1/usuarios/{idUsuario}/documentos/{idDocumento}`    | Actualización de documento de portal (v1)                        |
| `freematica_update_pcrm_documento_usuario_v2`           | `PUT /pcrm/v2/usuarios/{idUsuario}/documentos/{idDocumento}`    | Actualización de documento de portal (v2)                        |
...
| `freematica_create_proveedor`                           | `POST /pgrl/v2/proveedores`                                     | Alta de proveedor (campos nativos: COD_GRUPO_PRO, COD_PRO, NIF…) |
| `freematica_update_proveedor`                           | `PUT /pgrl/v2/proveedores/{idReg}`                              | Actualización parcial de proveedor (fetch+merge)                 |
| `freematica_create_localizacion_pago_proveedor`         | `POST /pgrl/v2/localizaciones-pago-proveedores`                 | Alta de localización de pago de proveedor                        |
| `freematica_update_localizacion_pago_proveedor`         | `PUT /pgrl/v2/localizaciones-pago-proveedores/{idReg}`          | Actualización parcial de localización de pago (fetch+merge v2)   |
| `freematica_create_calen_festivo`                       | `POST /pgrl/v2/calen-festivos`                                  | Alta de calendario festivo                                       |
...
| `freematica_create_instalador_propuesta_compra`         | `POST /pgrl/v1/instaladores/{idReg}/propuestas-compras`         | Alta de propuesta de compra para un instalador                   |
